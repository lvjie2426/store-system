...
public interface UserDao extends HDao<User> {
    ...
    public List<User> getAllLists(long sid, int userType, int status) throws DataAccessException;

    public List<User> getUsers(String phone)throws DataAccessException;
