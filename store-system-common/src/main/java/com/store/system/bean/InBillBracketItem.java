...
public class InBillBracketItem implements Serializable {
    ...
    public static InBillItem toInBillItem(InBillBracketItem one) {
        InBillItem res = new InBillItem();
        res.setId(one.getId());
        res.setType(InBillItem.type_bracket);
    ...
    public static InBillBracketItem fromInBillItem(InBillItem one) {
        if(one.getType() != InBillItem.type_bracket) return null;
        InBillBracketItem res = new InBillBracketItem();
        res.setId(one.getId());
        res.setIbid(one.getIbid());
        res.setGbid(one.getGbid());
        res.setGsid(one.getGsid());
