...
function openGoodsRange(title, isUpdate) {
    layer.open({
        type: 1,
        shade: 0.01,
        title: '设定' + title + '范围<span>点击或框选单元格来设定</span>',
...
function setRange(title, isUpdate) {
    ...
    cols.push({
        ...
        minWidth: 60,
        align: 'center',
        title: '<div class="yj-layui-table-header"><span>球</span><span>柱</span></div>',
        fixed: 'left'
    });
