...
public class SubordinateController extends BaseController {
    ...
    @RequestMapping("/getSubListByName")
    public ModelAndView getSubListByName(HttpServletRequest request, HttpServletResponse response, String name) throws Exception {
        try {
            List<Subordinate> subordinates = subordinateService.getAllParentSubordinate();
            List<Subordinate> res = Lists.newArrayList();
