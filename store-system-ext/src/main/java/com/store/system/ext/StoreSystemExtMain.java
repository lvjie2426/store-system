...
public class StoreSystemExtMain extends AbstractServer {

	private final static Logger logger = LoggerFactory.getLogger(StoreSystemExtMain.class);

	public StoreSystemExtMain(String[] anArgs) {
		super(anArgs);
	}
	...
	public static void runServer(String... args) throws Exception {
        ...
        StoreSystemExtMain server = new StoreSystemExtMain(args);
		server.run(args);
	}
